                ...
                hasOfferCatalog: {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      ...
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Physical Condition Inspection',
                      },
                    },
                    {
                      '@type': 'Offer',
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Avionics and Panel Review',
                      },
                    },
                    {
                      '@type': 'Offer',
                    ...
                    },
                    {
                      ...
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Discrepancy Summary and Buyer Decision Support',
                      },
                    },
                  ],
                },
      ...
      <main id="main-content" tabIndex={-1} className="bs-stage">
        <section className="hero-headline-group" aria-labelledby="prebuy-hero">
          ...
          <span className="bs-script-accent">
            &mdash; know what you are buying before the wire clears &mdash;
          </span>
          ...
          <p className="bs-subhead">
            Logbooks &middot; physical condition &middot; avionics &middot; NDT
            coordination &middot; discrepancy summary &middot; buyer decision
            support
          </p>
          <div className="bs-byline">
            RWAS Avionics Desk &middot; Supporting buyers across SD &middot; NE
            &middot; IA &middot; MN &middot; ND
          </div>
        </section>
        ...
        <div className="about-grid">
          <div className="about-main">
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  A pre-buy inspection exists to help a buyer understand risk
                  before closing on an aircraft. It is not a substitute for an
                  annual inspection, and it is not a guarantee that every future
                  problem has been found. It is a focused look at records,
                  condition, systems, obvious airworthiness concerns, and cost
                  drivers that can materially change the purchase decision.
                </p>
                <p>
                  Roger Wilco Aviation Services performs pre-buy support from an
                  FAA Part 145 repair-station environment for the Northern
                  Plains. That matters when a purchase question crosses
                  airframe, avionics, NDT, logbook, structural, or documentation
                  boundaries.
                </p>
              </div>
            </Specimen>
            ...
            <Specimen variant="hero" as="figure" className="about-fig">
              ...
              <Specimen.Caption numeral="FIG. 01">
                A useful pre-buy turns aircraft condition, records, and open
                questions into a decision the buyer can act on.
              </Specimen.Caption>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-split">
                <div className="bs-body">
                  <p>
                    The best pre-buy starts before the aircraft arrives.
                    Logbooks, equipment lists, photos, damage history, AD
                    status, service-bulletin concerns, and recent invoices tell
                    the shop where to look and which questions need a firm
                    answer.
                  </p>
                </div>
                <ul className="bs-svc-list">
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Inspection status, major repairs, STC history, AD/SB
                      concerns, recurring discrepancies, and gaps in
                      documentation.
                    </p>
                  </li>
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Airframe, engine-area, systems, obvious corrosion or
                      damage signs, and condition items visible within the
                      agreed scope.
                    </p>
                  </li>
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Installed equipment, upgrade potential,
                      database/connectivity questions, wiring concerns, and
                      Garmin-path implications.
                    </p>
                  </li>
                  <li className="bs-svc">
                    <p className="bs-svc-name">NDT coordination</p>
                    <p className="bs-svc-desc">
                      Eddy current, penetrant, magnetic particle, ultrasound, or
                      other inspection support when a known risk area deserves
                      more than a visual look.
                    </p>
                  </li>
                  <li className="bs-svc">
                    <p className="bs-svc-name">Discrepancy summary</p>
                    <p className="bs-svc-desc">
                      Practical findings framed around risk, likely cost
                      drivers, and buyer decision points.
                    </p>
                  </li>
                </ul>
              </div>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  The RWAS aircraft marketplace is built around cleaner
                  listings, photos, and logbook upload paths. When a buyer wants
                  more than listing copy, RWAS can help scope a pre-buy
                  inspection around that exact aircraft. Sellers and buyers
                  still control the transaction; RWAS provides inspection
                  support when requested.
                </p>
                <p>
                  A pre-buy is most useful when the buyer, seller, and shop
                  agree on the scope before the inspection begins. That prevents
                  the common failure mode where everyone assumes a different
                  level of review and nobody likes the invoice.
                </p>
              </div>
              <p>
                ...
                <Link
                  ...
                  href="/contact?reason=service&source=pre-buy-marketplace"
                >
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  Useful pre-buy requests include the aircraft make/model,
                  N-number, current location, seller contact path, asking price
                  if relevant, target closing date, logbook PDFs or photos,
                  recent inspection status, known squawks, damage history if
                  disclosed, and the buyer questions that would change the deal.
                </p>
              </div>
              <p>
                <Link
                  className="bs-cta-primary"
                  href="/contact?reason=service&source=pre-buy-inspection"
                >
          ...
          <aside
            ...
            aria-label="Pre-buy inspection quick reference"
          >
            <Specimen as="section">
            ...
            <div className="jerry-card">
              ...
              <a
                className="cta"
                href="/contact?reason=service&source=pre-buy-card"
              >
                Start pre-buy request
              </a>
              <div className="footnote">
                Scope is agreed before inspection work begins.
              </div>
            </div>
          </aside>
        </div>
        <RelatedReading service="pre-buy-inspection" />
      </main>
