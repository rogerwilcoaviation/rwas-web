                ...
                hasOfferCatalog: {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      ...
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Transponder Upgrade Planning',
                      },
                    },
                    {
                      '@type': 'Offer',
                      itemOffered: {
                        '@type': 'Service',
                        name: 'GPS Position Source Review',
                      },
                    },
                    {
                      '@type': 'Offer',
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Antenna and Wiring Planning',
                      },
                    },
                    {
                      '@type': 'Offer',
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Configuration and Compliance Documentation',
                      },
                    },
                  ],
                },
      ...
      <main className="bs-stage">
        <section className="hero-headline-group" aria-labelledby="adsb-hero">
          ...
          <span className="bs-script-accent">
            &mdash; transponder and ADS-B Out compliance planning &mdash;
          </span>
          ...
          <p className="bs-subhead">
            Transponder upgrades &middot; GPS source review &middot; antenna
            planning &middot; configuration &middot; FAR 91.227 documentation
          </p>
        ...
        <div className="about-grid">
          <div className="about-main">
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  ADS-B Out compliance is more than installing a transponder.
                  The aircraft needs an approved position source, correct
                  configuration, antenna and wiring decisions that fit the
                  airframe, and paperwork that makes the upgrade understandable
                  after the airplane leaves the shop.
                </p>
                <p>
                  RWAS plans ADS-B Out and transponder work from a certified
                  Garmin dealer and FAA Part 145 repair-station environment.
                  That lets the conversation cover the whole aircraft: existing
                  equipment, panel space, navigator compatibility, electrical
                  condition, antenna locations, future Garmin upgrades, and the
                  owner&apos;s actual mission.
                </p>
              </div>
            </Specimen>
            ...
            <Specimen variant="hero" as="figure" className="about-fig">
              ...
              <Specimen.Caption numeral="FIG. 01">
                Transponder and ADS-B decisions often connect to the rest of the
                panel, especially when a navigator, display, or autopilot
                upgrade is also planned.
              </Specimen.Caption>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-split">
                <div className="bs-body">
                  <p>
                    Some aircraft only need a focused ADS-B Out correction.
                    Others are better served by a transponder upgrade that is
                    planned alongside a GTN Xi navigator, G3X Touch display, G5,
                    GI 275, or autopilot project. RWAS helps sort the short-term
                    compliance need from the long-term panel plan.
                  </p>
                </div>
                <ul className="bs-svc-list">
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Identify the current transponder, encoder, GPS source,
                      antennas, and wiring condition before recommending a path.
                    </p>
                  </li>
                  <li className="bs-svc">
                    <p className="bs-svc-name">Garmin GTX planning</p>
                    <p className="bs-svc-desc">
                      Review Garmin transponder options in the context of the
                      aircraft, navigator, display, and ADS-B Out requirement.
                    </p>
                  </li>
                  <li className="bs-svc">
                    <p className="bs-svc-name">Antenna and wiring plan</p>
                    <p className="bs-svc-desc">
                      Plan location, routing, access, and installation details
                      instead of assuming old wiring is still the right answer.
                    </p>
                  </li>
                  <li className="bs-svc">
                    <p className="bs-svc-name">Configuration and validation</p>
                    <p className="bs-svc-desc">
                      Configure the system, complete functional checks, and
                      document the work for future maintenance.
                    </p>
                  </li>
                </ul>
              </div>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  Useful ADS-B quote requests include aircraft make/model,
                  N-number, current transponder model, current navigator or GPS
                  source, panel photos, antenna location photos if available,
                  and whether the owner is planning any other Garmin work during
                  the same downtime window.
                </p>
                <p>
                  If the airplane has an intermittent transponder, failing
                  altitude reporting, or a known ADS-B performance report issue,
                  include that history with the request. A compliance fix and a
                  clean installation quote are different jobs.
                </p>
              </div>
              <p>
                <Link
                  className="bs-cta-primary"
                  href="/contact?reason=quote&source=ads-b-installation"
                >
                  Request ADS-B quote
                </Link>
                <Link
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  Owners sometimes use an ADS-B project as the entry point for a
                  broader panel refresh. RWAS can help compare a focused
                  compliance job against a staged Garmin plan that also
                  addresses navigator, display, audio panel, autopilot, and
                  fabrication needs.
                </p>
              </div>
              <p>
          ...
          <aside
            ...
            aria-label="ADS-B installation quick reference"
          >
            <Specimen as="section">
            ...
            <div className="jerry-card">
              ...
              <div className="footnote">
                Compliance starts with the installed system, not the catalog
                page.
              </div>
            </div>
          </aside>
