...
const pageUrl = 'https://www.rogerwilcoaviation.com/services/aircraft-maintenance-yankton';

export const metadata = {
  title: { absolute: 'Aircraft Maintenance & Annual Inspections - Yankton, SD | RWAS' },
  description:
    'Aircraft maintenance, annual inspections, 100-hour inspections, pre-buy support, AOG service, and logbook documentation from FAA Part 145 repair station RWSR491E at KYKN in Yankton, SD.',
  alternates: { canonical: pageUrl },
};

export default function AircraftMaintenanceYanktonPage() {
  return (
    <BroadsheetLayout>
      <script
            ...
            '@graph': [
              {
                '@type': 'Service',
                '@id': `${pageUrl}#service`,
                name: 'Aircraft Maintenance and Annual Inspections in Yankton, SD',
                ...
                description:
                  'Aircraft maintenance, annual inspections, 100-hour inspections, pre-buy support, AOG service, propeller balancing, aircraft weight certification, and logbook documentation from Roger Wilco Aviation Services at Chan Gurney Municipal Airport in Yankton, South Dakota.',
                hasOfferCatalog: {
                  '@type': 'OfferCatalog',
              ...
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 3, name: 'Aircraft Maintenance Yankton', item: pageUrl },
                ],
              },
            ],
          }),
      ...
      <main className="bs-stage">
        <section className="hero-headline-group" aria-labelledby="maintenance-hero">
          ...
          <span className="bs-script-accent">&mdash; aircraft maintenance at KYKN &mdash;</span>
        ...
        <div className="about-grid">
          <div className="about-main">
            ...
            <Specimen variant="hero" as="section">
              ...
              <p>
                <Link className="bs-cta-primary" href="/contact?reason=service&source=aircraft-maintenance-yankton">
