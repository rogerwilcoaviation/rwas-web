                ...
                hasOfferCatalog: {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      ...
                      itemOffered: {
                        '@type': 'Service',
                        name: 'GTN 650Xi and GTN 750Xi Installation',
                      },
                    },
                    {
                      '@type': 'Offer',
                    ...
                    },
                    {
                      ...
                      itemOffered: {
                        '@type': 'Service',
                        name: 'GI 275 and G5 Instrument Installation',
                      },
                    },
                    {
                      '@type': 'Offer',
      ...
      <main className="bs-stage">
        ...
        >
          ...
          <h1
            ...
            className="bs-headline bs-headline--hero"
          >
          ...
          <p className="bs-subhead">
            G3X Touch &middot; GTN Xi &middot; GFC 500 &middot; GI 275 &middot;
            G5 &middot; ADS-B Out &middot; panel fabrication
          </p>
        ...
        <div className="about-grid">
          <div className="about-main">
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                ...
                <p>
                  RWAS supports Garmin installation projects for South Dakota,
                  Nebraska, Iowa, Minnesota, and North Dakota operators, with
                  practical quoting, aircraft review, product sourcing,
                  fabrication, wiring, testing, and logbook documentation
            ...
            <Specimen variant="hero" as="figure" className="about-fig">
              ...
              <Specimen.Caption numeral="FIG. 01">
                Cessna 182RG Garmin panel work - installation, fabrication, and
                finishing coordinated through RWAS.
              </Specimen.Caption>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-split">
                <div className="bs-body">
                  <p>
                    A good avionics quote is not just a cart of boxes. RWAS
                    starts with the aircraft, mission, existing equipment,
                    certification path, panel space, wiring condition, antenna
                    locations, electrical load, and owner priorities. From
                    there, the shop can recommend a Garmin path that fits the
                    airplane instead of forcing every aircraft into the same
                    panel.
                  </p>
                </div>
                <ul className="bs-svc-list">
                  <li className="bs-svc">
                    <p className="bs-svc-name">
                      <Link href="/services/g3x-touch-installation">
                        G3X Touch
                      </Link>
                    </p>
                    <p className="bs-svc-desc">
                      Glass-cockpit upgrades with ADAHRS, engine information,
                      synthetic vision, and display planning.
                    </p>
                  </li>
                  <li className="bs-svc">
                    <p className="bs-svc-name">
                      <Link href="/services/gtn-xi-navigator-installation">
                        GTN 650Xi / GTN 750Xi
                      </Link>
                    </p>
                    <p className="bs-svc-desc">
                      WAAS GPS/NAV/COMM navigator installs, panel integration,
                      and database-ready flight-deck workflow.
                    </p>
                  </li>
                  <li className="bs-svc">
                    <p className="bs-svc-name">
                      <Link href="/services/gfc-500-autopilot-installation">
                        GFC 500 Autopilot
                      </Link>
                    </p>
                    <p className="bs-svc-desc">
                      Retrofit autopilot planning for eligible aircraft,
                      including servo, control, and integration review.
                    </p>
                  </li>
                  <li className="bs-svc">
                    <p className="bs-svc-name">
                      GI 275, G5, GTX, GMA, and{' '}
                      <Link href="/services/ads-b-installation">ADS-B</Link>
                    </p>
                    <p className="bs-svc-desc">
                      Instrument, transponder, audio-panel, and ADS-B Out
                      compliance work.
                    </p>
                  </li>
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      In-house CAD, fiber laser cutting, powder coating, and UV
                      printing support for clean installations.
                    </p>
                  </li>
                </ul>
              </div>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  For a useful Garmin quote, RWAS needs the aircraft make and
                  model, N-number, current panel photos, equipment list, desired
                  capabilities, and any known maintenance or electrical issues.
                  A simple GPS replacement, an autopilot install, and a full
                  glass-panel conversion are very different projects even when
                  the product names overlap.
                </p>
                <p>
                  Owners can sketch a starting point in the panel planner,
                  browse Garmin collections for product context, or send the
                  shop a direct quote request. RWAS will still review
                  eligibility, certification path, lead time, aircraft downtime,
                  and fabrication needs before work begins.
                </p>
              </div>
              <p>
                <Link
                  className="bs-cta-primary"
                  href="/contact?reason=quote&source=garmin-installation"
                >
            ...
            <Specimen variant="hero" as="figure" className="about-fig">
              ...
              <Specimen.Caption numeral="FIG. 02">
                Garmin equipment selection is only one part of the project;
                installation planning controls the outcome.
              </Specimen.Caption>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  RWAS is not only a reseller. The shop operates as an FAA Part
                  145 repair station with airframe, instrument, radio, NDT, and
                  fabrication capability. That matters when a Garmin
                  installation exposes aging wiring, a panel structure problem,
                  a required placard, a weight-and-balance update, or a
                  maintenance finding that has to be resolved before the
                  aircraft leaves.
                </p>
                <p>
                  The goal is a finished aircraft that works as a system: legal,
                  documented, readable, serviceable, and matched to how the
                  owner actually flies.
                </p>
              </div>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  If you are comparing Garmin options, include your home
                  airport, typical trips, IFR/VFR use, current panel photos,
                  must-have equipment, and ideal downtime window. RWAS will
                  respond with the next practical step instead of a generic
                  brochure answer.
                </p>
              </div>
              <p>
                <Link
                  className="bs-cta-primary"
                  href="/contact?reason=quote&source=garmin-installation-northern-plains"
                >
          ...
          <aside
            ...
            aria-label="Garmin installation quick reference"
          >
            <Specimen as="section">
            ...
            <div className="jerry-card">
              ...
              <a
                className="cta"
                href="/contact?reason=quote&source=garmin-install-card"
              >
                Start quote
              </a>
              <div className="footnote">
                Eligibility and installation data are reviewed before
                scheduling.
              </div>
            </div>
          </aside>
