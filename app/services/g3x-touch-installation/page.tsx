                  ...
                  itemListElement: [
                    {
                      ...
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Aircraft and Mission Review',
                      },
                    },
                    {
                      '@type': 'Offer',
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Glass Panel Layout Planning',
                      },
                    },
                    {
                      '@type': 'Offer',
                      itemOffered: {
                        '@type': 'Service',
                        name: 'ADAHRS and EIS Integration Review',
                      },
                    },
                    {
                      '@type': 'Offer',
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Panel Fabrication Planning',
                      },
                    },
                    {
                      '@type': 'Offer',
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Configuration, Testing, and Documentation',
                      },
                    },
                  ],
                },
      ...
      <main id="main-content" tabIndex={-1} className="bs-stage">
        <section className="hero-headline-group" aria-labelledby="g3x-hero">
          ...
          <span className="bs-script-accent">
            &mdash; glass cockpit planning for piston aircraft &mdash;
          </span>
          ...
          <p className="bs-subhead">
            Display layout &middot; ADAHRS &middot; EIS &middot; navigator
            integration &middot; Connext workflow &middot; panel fabrication
          </p>
          ...
          <div className="about-main">
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  Garmin G3X Touch can become the center of a modern
                  piston-aircraft panel: flight display, engine information,
                  synthetic vision, connectivity, navigator integration, and a
                  cleaner operating workflow. The value comes from how the
                  system is planned, installed, configured, and documented
                  around the actual airplane.
                </p>
                <p>
                  RWAS plans G3X Touch installations from a certified Garmin
                  dealer and FAA Part 145 repair-station environment. The work
                  can include panel layout, ADAHRS planning, EIS sensor and
                  wiring review, navigator and transponder integration, Connext
                  workflow, panel fabrication, software configuration,
                  functional testing, and return-to-service documentation.
                </p>
              </div>
            </Specimen>
            ...
            <Specimen variant="hero" as="figure" className="about-fig">
              ...
              <Specimen.Caption numeral="FIG. 01">
                G3X Touch work connects display layout, engine data, flight
                instruments, connectivity, and the aircraft panel itself.
              </Specimen.Caption>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-split">
                <div className="bs-body">
                  <p>
                    A useful G3X Touch quote starts with what the aircraft needs
                    to do. IFR trips, engine-monitoring goals, autopilot plans,
                    navigator choices, future resale, and panel space all change
                    the right answer. RWAS uses that context to separate a clean
                    staged upgrade from an overbuilt wish list.
                  </p>
                </div>
                <ul className="bs-svc-list">
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Plan display size, radio stack, standby instruments,
                      breakers, switches, labels, and pilot workflow before
                      fabrication.
                    </p>
                  </li>
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Review attitude, air data, magnetometer, engine sensor,
                      and wiring requirements for the aircraft configuration.
                    </p>
                  </li>
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Coordinate G3X Touch with GTN Xi navigators, GFC 500
                      autopilot planning, transponder, audio, and standby
                      instruments.
                    </p>
                  </li>
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Plan Connext, Garmin Pilot, flyGarmin, data logging, and
                      maintenance visibility as part of the panel conversation.
                    </p>
                  </li>
                </ul>
              </div>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  G3X Touch projects often require new panel metal, placards,
                  paint or powder coat, labels, and a layout that respects
                  structure, clearances, wiring access, and future
                  serviceability. RWAS supports this with in-house CAD, fiber
                  laser cutting, powder coating, UV printing, and aircraft
                  maintenance review.
                </p>
                <p>
                  That matters when an owner wants the finished panel to look
                  clean and remain maintainable years later. A good panel is not
                  only attractive; it is readable, serviceable, documented, and
                  legal.
                </p>
              </div>
              <p>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  Useful G3X Touch quote requests include aircraft make/model,
                  N-number, serial number if available, current panel photos,
                  engine details, current navigator and transponder, current
                  autopilot, desired IFR/VFR mission, engine-monitoring goals,
                  and whether the owner wants a staged upgrade or one larger
                  downtime window.
                </p>
              </div>
              <p>
                <Link
                  className="bs-cta-primary"
                  href="/contact?reason=quote&source=g3x-touch-installation"
                >
          ...
          <aside className="about-rail" aria-label="G3X Touch quick reference">
            ...
            <div className="jerry-card">
              ...
              <div className="footnote">
                Layout, eligibility, fabrication, and wiring come before the
                final equipment list.
              </div>
            </div>
          </aside>
        </div>
        <RelatedReading service="g3x-touch-installation" />
      </main>
