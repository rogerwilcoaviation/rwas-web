                ...
                hasOfferCatalog: {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      ...
                      itemOffered: {
                        '@type': 'Service',
                        name: 'GTN 650Xi / 750Xi Selection Support',
                      },
                    },
                    {
                      '@type': 'Offer',
                    ...
                    },
                    {
                      ...
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Autopilot and Display Integration Review',
                      },
                    },
                    {
                      '@type': 'Offer',
      ...
      <main id="main-content" tabIndex={-1} className="bs-stage">
        <section className="hero-headline-group" aria-labelledby="gtn-hero">
          ...
          <span className="bs-script-accent">
            &mdash; IFR navigator installation and panel integration &mdash;
          </span>
          ...
          <p className="bs-subhead">
            WAAS GPS/NAV/COMM &middot; LPV approach capability &middot; antenna
            planning &middot; autopilot integration &middot; documentation
          </p>
        ...
        <div className="about-grid">
          <div className="about-main">
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  Garmin GTN 650Xi and GTN 750Xi navigators can anchor a modern
                  IFR panel with WAAS GPS, NAV/COMM capability, flight-plan
                  management, LPV approach capability, and integration with
                  displays, transponders, audio panels, and autopilots. The
                  equipment choice matters, but the installation plan matters
                  more.
                </p>
                <p>
                  RWAS plans GTN Xi installations from a certified Garmin dealer
                  and FAA Part 145 repair-station environment. That lets the
                  shop review the current panel, existing wiring and antennas,
                  navigator compatibility, autopilot path, display integration,
                  database workflow, and return-to-service documentation before
                  the aircraft is opened up.
                </p>
              </div>
            </Specimen>
            ...
            <Specimen variant="hero" as="figure" className="about-fig">
              ...
              <Specimen.Caption numeral="FIG. 01">
                Navigator work is rarely isolated: it affects the display,
                autopilot, audio panel, antenna plan, and pilot workflow.
              </Specimen.Caption>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-split">
                <div className="bs-body">
                  <p>
                    A GTN Xi quote should answer more than which screen size
                    fits the stack. RWAS reviews the aircraft mission, existing
                    avionics, IFR goals, autopilot plans, antenna condition,
                    wiring access, and future Garmin upgrade path so the
                    navigator supports the airplane instead of becoming an
                ...
                <ul className="bs-svc-list">
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Compare panel space, workflow, display needs, budget, and
                      downstream integration before choosing the navigator.
                    </p>
                  </li>
                  <li className="bs-svc">
                    <p className="bs-svc-name">Antenna and wiring review</p>
                    <p className="bs-svc-desc">
                      Plan GPS/NAV/COMM antenna work, cable condition, routing,
                      access, and installation detail before downtime starts.
                    </p>
                  </li>
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Coordinate the GTN Xi with GFC 500, G3X Touch, GI 275, G5,
                      transponder, and audio-panel decisions.
                    </p>
                  </li>
                  <li className="bs-svc">
                    <p className="bs-svc-name">
                    ...
                    <p className="bs-svc-desc">
                      Configure, test, document, and return the aircraft to
                      service with future troubleshooting in mind.
                    </p>
                  </li>
                </ul>
              </div>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  Useful GTN Xi quote requests include aircraft make/model,
                  N-number, current radio stack, current GPS/NAV/COMM equipment,
                  current transponder and audio panel, autopilot status, panel
                  photos, IFR mission, and whether a G3X Touch, GFC 500, ADS-B,
                  or panel fabrication project is also being considered.
                </p>
              </div>
              <p>
                <Link
                  className="bs-cta-primary"
                  href="/contact?reason=quote&source=gtn-xi-installation"
                >
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  A GTN Xi can be a focused IFR navigator upgrade, or it can be
                  the first piece of a broader Garmin panel. RWAS can help
                  decide whether to stage the work or bundle it with display,
                  autopilot, transponder, audio, and fabrication changes.
                </p>
              </div>
              <p>
                <Link
          ...
          <aside
            ...
            aria-label="GTN Xi navigator quick reference"
          >
            <Specimen as="section">
            ...
            <div className="jerry-card">
              ...
              <div className="footnote">
                A clean navigator install should support the next upgrade, not
                block it.
              </div>
            </div>
          </aside>
        </div>
        <RelatedReading service="gtn-xi-navigator-installation" />
      </main>
