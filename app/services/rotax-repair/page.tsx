                  ...
                  itemListElement: [
                    {
                      ...
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Rotax Engine Inspection Support',
                      },
                    },
                    {
                      '@type': 'Offer',
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Light Sport Aircraft Maintenance',
                      },
                    },
                    {
                      '@type': 'Offer',
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Condition Inspection Support',
                      },
                    },
                    {
                      '@type': 'Offer',
                    ...
                    },
                    {
                      ...
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Maintenance Documentation Review',
                      },
                    },
                  ],
                },
      ...
      <main className="bs-stage">
        <section className="hero-headline-group" aria-labelledby="rotax-hero">
          ...
          <span className="bs-script-accent">
            &mdash; Rotax engine support with repair-station discipline &mdash;
          </span>
          ...
          <p className="bs-subhead">
            912 &middot; 914 &middot; 915 iS &middot; 916 iS &middot; light
            sport &middot; experimental &middot; inspection and troubleshooting
            support
          </p>
        ...
        <div className="about-grid">
          <div className="about-main">
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  Rotax engines have become a serious part of the light sport,
                  experimental, and modern piston-aircraft conversation. The 912
                  and 914 families built the foundation, while the 915 iS and
                  916 iS brought turbocharged and fuel-injected capability to
                  aircraft that do not fit the old Lycoming-or-Continental-only
                  mental model.
                </p>
                <p>
                  Roger Wilco Aviation Services supports owners who need Rotax
                  maintenance help without treating the engine as an oddity. The
                  work still starts with the aircraft, the engine logbooks, the
                  operating history, the maintenance manuals, and the question
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-split">
                <div className="bs-body">
                  <p>
                    Rotax requests usually arrive with a specific concern: an
                    inspection interval, a starting or running issue, a service
                    bulletin question, a pre-buy finding, an aircraft that has
                    sat too long, or a logbook history that needs to be
                    understood before the next flight. RWAS can help scope the
                    work, identify the correct data path, and determine whether
                    the aircraft should come to the shop.
                  </p>
                </div>
                <ul className="bs-svc-list">
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Review of aircraft/engine history, maintenance status,
                      intervals, and owner concerns.
                    </p>
                  </li>
                  <li className="bs-svc">
                    <p className="bs-svc-name">Troubleshooting</p>
                    <p className="bs-svc-desc">
                      Starting, idle, charging, sensor, cooling, fuel, and
                      operational complaints scoped around the specific
                      installation.
                    </p>
                  </li>
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Maintenance support for aircraft where the engine,
                      airframe, and documentation path must be reviewed
                      together.
                    </p>
                  </li>
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Help understanding what has been done, what is due, and
            ...
            <Specimen variant="hero" as="figure" className="about-fig">
              ...
              <Specimen.Caption numeral="FIG. 01">
                Rotax work is still aircraft work: manuals, logbooks, inspection
                scope, and documentation matter.
              </Specimen.Caption>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  Rotax-powered aircraft often sit at the intersection of
                  engine-specific maintenance requirements, airframe-specific
                  instructions, experimental or light-sport operating
                  limitations, and owner-maintained records. RWAS approaches
                  that as a documentation problem as much as a mechanical one.
                </p>
                <p>
                  Owners should send engine model, serial number if available,
                  aircraft make and model, hours, recent maintenance, symptoms,
                  and logbook photos before the first visit. That lets the shop
                  review the likely path before turning the appointment into
                  guesswork.
                </p>
              </div>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  Include the aircraft make/model, engine model, N-number if
                  applicable, engine hours, last inspection, recent maintenance,
                  symptoms, photos, and any service bulletin or manual reference
                  that triggered the question. If the aircraft is experimental
                  or light sport, include the operating limitations and any
              ...
              <p>
                <Link
                  ...
                  href="/contact?reason=service&source=rotax-repair"
                >
          ...
          <aside
            ...
            aria-label="Rotax maintenance quick reference"
          >
            <Specimen as="section">
            ...
            <div className="jerry-card">
              ...
              <a
                className="cta"
                href="/contact?reason=service&source=rotax-card"
              >
                Start request
              </a>
              <div className="footnote">
                Manuals and logbook context help avoid bad assumptions.
              </div>
            </div>
          </aside>
        </div>
