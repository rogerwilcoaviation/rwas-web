                ...
                hasOfferCatalog: {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      ...
                      itemOffered: {
                        '@type': 'Service',
                        name: 'Sheet Metal Repair Support',
                      },
                    },
                    {
                      '@type': 'Offer',
                    ...
                    },
                    {
                      ...
                      itemOffered: {
                        '@type': 'Service',
                        name: 'CAD and CNC Fabrication Support',
                      },
                    },
                  ],
                },
      ...
      <main className="bs-stage">
        ...
        >
          ...
          <figcaption
            ...
            id="fabrication-video-title"
          >
            <span>RWAS capability reel</span>
            <strong>
              Fiber laser cutting, aircraft panel workflow, fabrication,
              finishing, and shop support under one roof.
            </strong>
          </figcaption>
        </figure>
        ...
        <section className="hero-headline-group" aria-labelledby="laser-hero">
          <span className="bs-kicker">
            Fabrication &amp; Manufacturing &middot; FAA Part 145 Repair Station
            #RWSR491E
          </span>
          <span className="bs-script-accent">
            &mdash; cut, marked, finished, and reviewed in-house &mdash;
          </span>
          ...
          <p className="bs-subhead">
            Fiber laser cutting &middot; laser welding &middot; panel
            fabrication &middot; powder coating &middot; UV printing &middot;
            CAD/CNC support
          </p>
          <div className="bs-byline">
            RWAS Avionics Desk &middot; Serving aircraft owners and shops across
            the Northern Plains
          </div>
        </section>
        ...
        <div className="about-grid">
          <div className="about-main">
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  Roger Wilco Aviation Services uses in-house fiber laser
                  cutting and welding to support aircraft panel work, sheet
                  metal projects, brackets, tooling, and short-run aviation
                  parts that need clean edges, repeatable geometry, and fast
                  iteration. The advantage is not just the machine. It is having
                  the machine inside the same shop that understands avionics
                  clearances, structural judgment, logbook documentation,
                  placards, and return-to-service requirements.
                </p>
                <p>
                  RWAS can take a project from aircraft review and CAD layout
                  through cutting, finishing, marking, and installation
                  planning. That shortens the loop for owners who need panel
                  modernization, replacement metal, custom brackets, or a
                  manufactured tool that has to survive normal hangar use.
                </p>
              </div>
            </Specimen>
            ...
            <Specimen variant="hero" as="figure" className="about-fig">
              ...
              <Specimen.Caption numeral="FIG. 01">
                RWAS fiber laser cutting capability - used for panel, tooling,
                and fabrication support in the Northern Plains.
              </Specimen.Caption>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  Aircraft panel work starts before the laser ever runs. RWAS
                  reviews the aircraft, instrument layout, equipment stack,
                  structural constraints, wiring path, placards, and applicable
                  installation data. Once the concept is ready, the shop can
                  move from CAD to cut metal without handing the project to an
                  outside vendor that has never seen the airplane.
                </p>
                <p>
                  Owners planning a Garmin upgrade can use the panel planner as
                  an early conversation tool, then have RWAS review the actual
                  aircraft and project scope before fabrication begins.
                </p>
              </div>
              <p>
                ...
                <Link
                  ...
                  href="/contact?reason=service&source=fiber-laser-panel"
                >
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-split">
                <div className="bs-body">
                  <p>
                    The fiber laser supports precise work in thin-gauge metals
                    used in aircraft and tooling projects. RWAS pairs that with
                    CAD/CNC workflow, powder coating, UV printing, and CO2
                    engraving so the finished part is not just shaped correctly,
                    but readable, durable, and ready for a professional aircraft
                    environment.
                  </p>
                </div>
                <ul className="bs-svc-list">
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Repeatable cut geometry for panels, brackets, fixtures,
                      and short-run shop parts.
                    </p>
                  </li>
                  <li className="bs-svc">
                    <p className="bs-svc-name">Fiber Laser Welding</p>
                    <p className="bs-svc-desc">
                      Precision joining support where material, geometry, and
                      approved data make it appropriate.
                    </p>
                  </li>
                  <li className="bs-svc">
                    <p className="bs-svc-name">Aircraft Panel Fabrication</p>
                    <p className="bs-svc-desc">
                      Panel blanks, instrument openings, avionics layouts,
                      placard areas, and fit checks.
                    </p>
                  </li>
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Finished panels and tools with durable color, labeling,
                  ...
                  <li className="bs-svc">
                    ...
                    <p className="bs-svc-desc">
                      Digital layout, repeatable manufacturing files, CNC
                      routing, and production support.
                    </p>
                  </li>
                </ul>
              </div>
            ...
            <Specimen variant="hero" as="figure" className="about-fig">
              ...
              <Specimen.Caption numeral="FIG. 02">
                Custom panel work - precision cut, finished, and marked for a
                professional cockpit installation.
              </Specimen.Caption>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  Fabrication for aircraft is not the same as hobby cutting.
                  RWAS reviews eligibility, installation data, structure,
                  clearances, equipment requirements, placards, and
                  documentation before treating a fabricated item as aircraft
                  work. Some projects can be handled as shop support or tooling;
                  others require approved data, STC/AML compatibility,
                  coordination with an IA, or a different path entirely.
                </p>
                <p>
                  That discipline is the point. The shop can move quickly, but
                  it will not turn an aircraft project into a loose piece of
                  metal with no regulatory story behind it.
                </p>
              </div>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  Useful fabrication requests include the aircraft make and
                  model, N-number if aircraft-specific, photos of the panel or
                  part, dimensions, material if known, the desired finish or
                  marking, and the maintenance or installation reason behind the
                  work. If the project ties into a Garmin installation,
                  structural repair, or Papa-Alpha tooling question, include
              ...
              <p>
                <Link
                  ...
                  href="/contact?reason=service&source=fiber-laser-fabrication"
                >
                  Request fabrication support
                </Link>
                <Link
                  className="bs-cta-secondary"
                  href="/shop-capabilities#fabrication"
                >
          ...
          <aside
            ...
            aria-label="Fabrication quick reference"
          >
            <Specimen as="section">
            ...
            <div className="jerry-card">
              ...
              <a
                className="cta"
                href="/contact?reason=service&source=fiber-laser-card"
              >
                Start request
              </a>
              <div className="footnote">
                Aircraft work is reviewed before metal is cut.
              </div>
            </div>
          </aside>
        </div>
