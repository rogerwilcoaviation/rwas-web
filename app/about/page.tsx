      ...
      <main className="bs-stage">
        ...
        <section className="hero-headline-group" aria-labelledby="about-hero">
          ...
          <span className="bs-script-accent">
            &mdash; wheels-up since 2022 &mdash;
          </span>
          ...
          <div className="bs-byline">
            ...
            &middot; Powerplant &middot; NDT &middot; Fabrication
            &nbsp;&middot;&nbsp; Authorized Garmin Dealer
          </div>
          <div className="bs-body">
            <p>
              ...
              RWSR491E for a complete range of maintenance, repair, and
              alteration work.
            </p>
          </div>
        </section>
          ...
          <div className="about-main">
            ...
            <Specimen variant="hero" as="section">
              ...
              <div className="bs-body">
                <p>
                  ...
                  captain with more than 40 years of aviation experience
                  spanning airline operations, aircraft maintenance, avionics
                  systems, and flight instruction. What started as a
                  single-hangar maintenance shop has evolved into a full-service
                  FAA-certificated repair station serving aircraft owners and
                  operators across the upper Midwest and beyond.
                </p>
                <p>
                  Halsted earned his Airline Transport Pilot certificate at 21
                  and has spent the decades since building deep expertise on
                  both sides of the cockpit, flying the line and turning
                  wrenches. That dual perspective shapes everything RWAS does.
                </p>
                <p>
                  In its early years the shop focused on annual inspections,
                  airframe repair, and basic avionics work for the local
                  general-aviation fleet. When the Garmin glass-cockpit
                  revolution reshaped the industry, Halsted saw an opportunity:
                  bring modern avionics capability to the Northern Plains, a
                  region where most owners had been forced to ferry their
                  aircraft hundreds of miles to metro shops for panel upgrades.
                  RWAS became a certified Garmin dealer and installation center,
                  specializing in the G3X Touch suite, GTN Xi navigator series,
            ...
            <Specimen variant="hero" as="figure" className="about-fig">
              ...
              <Specimen.Caption numeral="FIG. 01">
                Custom, precision laser-cut, powder coated, &amp; UV printed to
                perfection, single panel for a Cessna 182RG.
              </Specimen.Caption>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <h2 className="bs-headline bs-headline--section">
                Precision Rigging, Built In-House
              </h2>
              <hr className="section-rule" />
              <div className="bs-body">
                <p>
                  One of the unique capabilities to come out of the RWAS shop is
                  the Papa-Alpha line of precision rigging reference tools for
                  Piper aircraft. Designed by Halsted after years of frustration
                  with imprecise field methods for flight control rigging, the
                  Papa-Alpha tools are CNC-machined from aircraft-grade
                  aluminum, powder coated, and UV printed with permanent
                  reference markings.
                </p>
                <p>
                  The tools cover stabilator, rudder, aileron, flap, and bell
                  crank rigging for the PA-28, PA-30, PA-31, and PA-36 series
                  &mdash; replacing the guesswork and tribal knowledge that has
                  plagued Piper rigging for decades. Papa-Alpha tools are now
                  shipped worldwide to maintenance shops, flight schools, and
                  individual owners, and are available through
                  rogerwilcoaviation.com, Aircraft Spruce, and Amazon.
                </p>
              </div>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <h2 className="bs-headline bs-headline--section">
                NDT, Fabrication &amp; Laser Cutting
              </h2>
              <hr className="section-rule" />
              <div className="bs-body">
                <p>
                  Beyond avionics and airframe maintenance, RWAS operates
                  non-destructive testing services including eddy current, dye
                  penetrant, and magnetic particle inspection. The shop also
                  maintains a sheet metal fabrication capability for structural
                  repairs, custom cowlings, and bracket fabrication in
                  aircraft-grade aluminum alloys.
                </p>
                <p>
                  Recent additions include a fiber laser cutting and welding
                  system, enabling precision work on thin-gauge metals that was
                  previously outsourced. This technology supports both aircraft
                  work and the manufacturing of Papa-Alpha tools in-house.
                </p>
              </div>
            </Specimen>
            ...
            <Specimen variant="hero" as="section">
              ...
              <h2 className="bs-headline bs-headline--section">
                Honest Work, Documented Right.
              </h2>
              <hr className="section-rule" />
              <div className="bs-body">
                <p>
                  To deliver honest, professional aircraft maintenance and
                  avionics work &mdash; on time, documented correctly, and built
                  to last. Every aircraft that leaves this shop is one
                  we&rsquo;d fly ourselves.
                </p>
              </div>
              <div className="bs-pullquote">
                We don&rsquo;t just fix aircraft &mdash; we keep them flying
                safely.
              </div>
            </Specimen>
          </div>
