...
export const metadata = {
  title: { absolute: 'Privacy Policy | Roger Wilco Aviation Services' },
  description:
  ...
  alternates: { canonical: 'https://www.rogerwilcoaviation.com/privacy' },
};
    ...
    <BroadsheetLayout>
      ...
      <main className="bs-stage">
        ...
        <section className="hero-headline-group" aria-labelledby="privacy-hero">
          ...
          <span className="bs-script-accent">&mdash; how we handle your data &mdash;</span>
