...
export const metadata = genPageMetadata({
  title: 'Privacy Policy | Roger Wilco Aviation Services',
  description:
    'Privacy policy for Roger Wilco Aviation Services (rogerwilcoaviation.com). How we handle data from customers, the aircraft marketplace, and Captain Jerry.',
  canonical: 'https://www.rogerwilcoaviation.com/privacy',
});
...
export default function PrivacyPolicyPage() {
  return (
    <BroadsheetLayout>
      <Dateline />
      <Masthead />
      <BroadsheetNav activeHref="/privacy" />
      <CredentialsBar />
      <BulletinBar />
      ...
      <main id="main-content" tabIndex={-1} className="bs-stage">
        ...
        <section className="hero-headline-group" aria-labelledby="privacy-hero">
          ...
          <span className="bs-script-accent">
            &mdash; how we handle your data &mdash;
          </span>
          <h1 id="privacy-hero" className="bs-headline bs-headline--hero">
            Privacy Policy
          </h1>
          <p className="bs-subhead">
            What we collect, why, how long we keep it, and the rights you have
            over it.
          </p>
        ...
        <section className="max-w-screen-md mx-auto policy-card rounded shadow-md p-6 mb-8" aria-labelledby="browser-analytics-notice">
          ...
          <p>Captain Jerry keeps recent conversation history in your tab’s sessionStorage. Sending a message transmits your conversation through our Cloudflare-hosted service and RWAS-operated relay to our AI response service, configured to request OpenAI GPT models. Server-side processing can create conversation records and operational logs; a fixed retention period covering those records has not been established. Do not enter passwords, payment-card details, or sensitive personal information. Clearing browser data does not delete information already received by our services.</p>
        ...
        <div className="mt-12 max-w-screen-md mx-auto policy-card rounded shadow-md p-6 mb-8">
          <p>
            ...
            purchase from{' '}
            <span className="font-bold">{siteMetadata.domain}</span> (the
        ...
        <div className="max-w-screen-md mx-auto policy-card rounded shadow-md p-6 mb-8">
          ...
          <p>
            ...
            your username, password, or other access details with anyone else.
        ...
        <div className="max-w-screen-md mx-auto policy-card rounded shadow-md p-6 mb-8">
          ...
          <p>
            ...
            also permit third parties and service providers to use Cookies on
            our Site to better tailor the services, products, and advertising on
        ...
        <div className="max-w-screen-md mx-auto policy-card rounded shadow-md p-6 mb-8">
          ...
          <p>
            ...
            decision by contacting us using the contact details set out below or
