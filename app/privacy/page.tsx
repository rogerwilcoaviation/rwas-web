    ...
    <BroadsheetLayout>
      ...
      <main id="main-content" tabIndex={-1} className="bs-stage">
        ...
        <section className="max-w-screen-md mx-auto policy-card rounded shadow-md p-6 mb-8" aria-labelledby="browser-analytics-notice">
          ...
          <p>Captain Jerry keeps recent conversation history in your tab’s sessionStorage. Sending a message transmits your conversation through our Cloudflare-hosted service and RWAS-operated relay to OpenAI models for a response. Server-side processing can create conversation records and operational logs; a fixed retention period covering those records has not been established. Do not enter passwords, payment-card details, or sensitive personal information. Clearing browser data does not delete information already received by our services.</p>
