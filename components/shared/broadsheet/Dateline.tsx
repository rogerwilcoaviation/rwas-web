    ...
    <div className="bs-dateline">
      <div className="bs-dateline__inner">
        <div className="bs-dateline__left">
          <span className="bs-dateline__edition">{edition}</span>
          <span className="bs-dateline__volume">{volume}</span>
          <span className="bs-dateline__domain">{domain}</span>
          {kicker ? (
            <span className="bs-dateline__kicker">{kicker}</span>
          ) : null}
        </div>
