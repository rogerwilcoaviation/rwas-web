...
Primary category should match what Google allows and what RWAS wants to win locally. Candidate categories:
...
- GFC 500 autopilot installation
...
Q: Does RWAS offer aircraft NDT inspection?  
...
- Shop floor
- Avionics panel work
- Fabrication/fiber laser setup
- NDT equipment
- Papa-Alpha tools
- Team photo, if appropriate

## Final Step

After GBP is updated, run a citation check and update `docs/seo/citation-tracker.md` with the verified GBP review link and final category choices.
